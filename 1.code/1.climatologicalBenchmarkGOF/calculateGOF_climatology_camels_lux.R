...
stns<-read.csv("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-lux/CAMELS_LUX/CAMELS_LUX_meta_attributes.csv")%>%
...
for(it in 1:nrow(stns)){
  ...
  dat<-read.csv(paste0(
    "../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-lux/CAMELS_LUX/timeseries/daily/CAMELS_LUX_hydromet_timeseries_",
...
write.csv(stn_var,"2.data/varComponents/camels_lux.csv",row.names = FALSE)
...
st_write(stns,"2.data/GOF/camels_lux.gpkg",append = FALSE)
