...
stn_var<-data.frame(govnr = stns$govnr,
                    varSeas_stl = NA,
...
write.csv(stn_var,"2.data/varComponents/lamah_ce.csv",row.names = FALSE)
...
st_write(stns,"2.data/GOF/lamah_ce.gpkg",append = FALSE)
