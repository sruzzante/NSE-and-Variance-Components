...
stns<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-fr/CAMELS_FR_geography/CAMELS_FR_gauge_outlet.gpkg")
...
stn_var<-data.frame(sta_code_h3 = stns$sta_code_h3,
                    varSeas_stl = NA,
...
write.csv(stn_var,"2.data/varComponents/camels_fr.csv",row.names = FALSE)


st_write(stns,"2.data/GOF/camels_fr.gpkg",append = FALSE)
