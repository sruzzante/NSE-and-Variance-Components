...
for(it in 1:nrow(stns)){
  ...
  #read in data
  nc_dat<-nc_open(paste0("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-es/timeseries/netcdf/camelses/",
                         stns$gauge_id[it],".nc"))
...
write.csv(stn_var,"2.data/varComponents/camels_es.csv",row.names = FALSE)
...
st_write(stns,"2.data/GOF/camels_es.gpkg",append = FALSE)
