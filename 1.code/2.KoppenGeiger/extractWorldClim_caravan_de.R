# get climatology for caravan-de
...
sf_use_s2(FALSE)
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/caravan-de/shapefiles/camelsde/camelsde_basin_shapes.shp")%>%
...
write.csv(dat,"2.data/worldclim/caravan_de_clim.csv")
