...
sf_use_s2(FALSE)
rm(list = ls())
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-gb/data/CAMELS_GB_catchment_boundaries.shp")%>%
  st_transform(st_crs("EPSG:4326"))

watersheds$gauge_id<-watersheds$ID_STRING
...
write.csv(dat,"2.data/worldclim/camels_gb_clim.csv")
