# get climatology for caravan-il
...
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/caravan_ext_israel/shapefiles/il/il_basin_shapes.shp")%>%
...
write.csv(dat,"2.data/worldclim/caravan_il_clim.csv")
