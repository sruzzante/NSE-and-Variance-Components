...
sf_use_s2(FALSE)
rm(list = ls())
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-dk/Shapefile/CAMELS_DK_304_gauging_catchment_boundaries.shp")%>%
...
watersheds$gauge_id<-watersheds$catch_id
...
write.csv(dat,"2.data/worldclim/camels_dk_clim.csv")
