...
sf_use_s2(FALSE)
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-fr/CAMELS_FR_geography/CAMELS_FR_catchment_boundaries.gpkg")%>%
  st_transform(st_crs("EPSG:4326"))

watersheds$gauge_id<-watersheds$sta_code_h3
...
write.csv(dat,"2.data/worldclim/camels_fr_clim.csv")
