# get climatology for camels-lux
...
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-lux/CAMELS_LUX/catchments_CAMELS-LUX.shp")%>%
  st_transform(st_crs("EPSG:4326"))

watersheds$gauge_id<-watersheds$gridcode
...
write.csv(dat,"2.data/worldclim/camels_lux_clim.csv")
