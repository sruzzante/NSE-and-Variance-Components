...
sf_use_s2(FALSE)
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/caravan/Caravan/shapefiles/combined.shp")%>%
...
write.csv(dat,"2.data/worldclim/caravan_clim.csv")
