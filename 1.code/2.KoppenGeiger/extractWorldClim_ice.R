...
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/lamah_ice/lamah_ice/A_basins_total_upstrm/3_shapefiles/Basins_A.shp")%>%
  st_transform(st_crs("EPSG:4326"))

stns<-read.csv("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/lamah_ice/lamah_ice/D_gauges/1_attributes/Gauge_attributes.csv",sep = ";")
watersheds<-left_join(watersheds,stns%>%select(id,V_no))

watersheds$gauge_id<-watersheds$id
...
write.csv(dat,"2.data/worldclim/lamah_ice_clim.csv")
