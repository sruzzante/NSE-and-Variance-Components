...
sf_use_s2(FALSE)
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/hysets/HYSETS_watershed_boundaries_20200730.shp")

watersheds<-  st_set_crs(watersheds,st_crs("EPSG:4326"))


watersheds$gauge_id<-watersheds$OfficialID
...
write.csv(dat,"2.data/worldclim/hysets_clim.csv")
