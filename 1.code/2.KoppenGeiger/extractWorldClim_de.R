...
sf_use_s2(FALSE)
rm(list = ls())
stns<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-de/CAMELS_DE_catchment_boundaries/gauging_stations/CAMELS_DE_gauging_stations.gpkg")
watersheds<-st_read("../DATA/1.Spatial_data/global/sw_surfacewater_streamflow_runoff_river_network_waterstress/camels-de/CAMELS_DE_catchment_boundaries/catchments/CAMELS_DE_catchments.gpkg")%>%
...
write.csv(dat,"2.data/worldclim/camels_de_clim.csv")
