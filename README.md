...
/1.code/1.climatologicalBenchmarkGOF/ contains the scripts to analyse streamflow data and calculate the variance components and benchmark NSEs for each catchment
